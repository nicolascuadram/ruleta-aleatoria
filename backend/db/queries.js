...
export const postQueries = {
    ...
    AddRegistro: `INSERT INTO registro (ref_incidencia, ref_grupo, alumnoescogido, fecha, comentario) 
                  VALUES ($1, $2, $3, CURRENT_TIMESTAMP, $4) RETURNING *`,
    AddHistorialRuleta: "INSERT INTO historial_ruleta (instancia_id, valor) VALUES ($1, $2) RETURNING *"
}
